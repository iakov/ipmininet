...
[![Build Status](https://github.com/iakov/ipmininet/actions/workflows/test.yaml/badge.svg)](https://github.com/iakov/ipmininet/actions/workflows/test.yaml)
...
For development setup, quirks and workarounds, see [DEVELOPMENT.md](DEVELOPMENT.md).
